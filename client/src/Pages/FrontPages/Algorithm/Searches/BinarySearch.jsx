...
import VisualizeBinary from "../../../Visualizations/VisualizeBinary";
import "../../../../index.css";
...
const BinarySearch = () => {
  ...
  useEffect(() => {
    ...
    if (algorithmName && algorithmName.toLowerCase() === 'binary search') {
  ...
  return (
    <div className="bg-color h-screen">
      <div className="max-w-[1200px] m-auto h-full">
        <VisualizeHeader
          routePath="/algorithms/search/binary-search"
            ...
            <form className="mb-8 flex justify-center items-center flex-col space-y-4">
              ...
              <div className="flex gap-2 py-4">
                <button
                  ...
                  className="shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] hover:scale-110 hover:card-heading hover:shadow-[0_10px_20px_rgba(240,_46,_170,_0.7)] bg-blue-500 text-white py-2 px-4 rounded"
                >
                  Visualize
                </button>
              </div>
